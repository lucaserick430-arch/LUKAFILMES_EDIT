...
app.post("/api/admin/usuarios/editar", async (req, res) => {
    ...
    try {
        ...
        if (
            !["usuario", "teste", "revendedor", "admin"]
                .includes(tipo)
        ) {
            return res.status(400).json({
                sucesso: false,
        ...
        conta.whatsapp = telefone;
        conta.valor = valor;
        conta.valor_mensal = valor;

        /*
         * A senha só é alterada quando o ADMIN
         * preencher o campo "Nova senha".
         *
         * Se ficar vazio, a senha atual permanece.
         */
        if (senha.trim()) {
        ...
        /*
         * Se o próprio usuário editado estiver
         * conectado em outra sessão, não alteramos
         * a sessão dele aqui. A nova senha passa
         * a valer no próximo login.
         */
