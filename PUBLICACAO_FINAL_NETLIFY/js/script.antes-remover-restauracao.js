...
window.addEventListener("pageshow", function(event) {
    ...
    // Se voltou pelo botão Voltar do navegador,
    // não apaga a pesquisa salva.
    if (event.persisted) {

        console.log(
            "[CATÁLOGO] Voltou pelo histórico. Restaurando sugestões..."
        );
    ...
    // Entrada normal na página inicial:
    // começa completamente limpa.
    const campo = document.getElementById("campoBusca");
    ...
    sessionStorage.removeItem("lukafilmes_busca");
...
// CLICAR NA BARRA LIMPA AS SUGESTÕES RESTAURADAS
    ...
    function () {
        ...
        campo.addEventListener(
            ...
            function () {
                ...
                console.log(
                    "[PESQUISA] Sugestões limpas ao clicar na barra."
                );
