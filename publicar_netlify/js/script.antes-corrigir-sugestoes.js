...
async function pesquisarFilmes() {
    ...
    buscaAtual = busca;
    sessionStorage.setItem("lukafilmes_busca", busca);
...
function restaurarPesquisa() {
    ...
    campo.value = buscaSalva;

    console.log(
        "[PESQUISA] Restaurando:",
        buscaSalva
    );
...
// Restaurar também quando a página voltar pelo histórico
