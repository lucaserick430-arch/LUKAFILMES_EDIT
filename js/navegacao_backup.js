...
function criarBotaoAdmin() {
    ...
    // ADMIN aparece somente na página inicial
...
function criarBotaoRevenda() {

    if (document.querySelector(".lukafilmes-revenda")) {
        return;
    }
    ...
    .then(function(dados) {
        ...
        botao.href = "/revendedor.html";
        botao.className = "lukafilmes-revenda";
        botao.setAttribute(
            "data-lukafilmes-revenda",
            "true"
        );

        botao.innerHTML = "<span>PAINEL DE REVENDA</span>";
    ...
    .catch(function(erro) {
        ...
        console.warn(
            "[NAVEGAÇÃO] Erro ao verificar revendedor:",
            erro
        );
